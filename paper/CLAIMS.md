...
| ~18.8k lines of Rust, 8 crates, 260 tests | measured in-tree: `git ls-files 'crates/**/*.rs'` piped to `xargs wc -l` = 18,801 (tests + the S10 bench bin included); grep-count `#[test]`+`#[tokio::test]` = 260; crates: broker, capsule, convex-codec, host, ipc, runner, store-postgres, v8cell | MEASURED (2026-07-16, branch v0.7-write-path, post-final-review fix round — re-measure at submission) |
...
- **Integration-proof count:** 15 as of the S10 stamp (base 10 at c615bd9 → +1 clamp
  ...
  Paper and this ledger say sixteen. Re-count at any fence-touching merge.
...
- **LOC:** README says "roughly 10k" (stale there too); measured 18,801 incl. tests
  + the S10 bench bin on this tree (2026-07-16, v0.7-s10 @ 8cb09c7; 17,727 without
  `crates/ipc/examples/`). Paper says "roughly eighteen thousand… (18.8k measured,
...
- **Count-carrying lines** (re-stamped 2026-07-16 at the S10 landing —
  LOC 18,801 / 260 tests / sixteen fence proofs / codec 18-total-14-rejection):
